...
const Footer = () => {
    return (
        <div className='w-full mt-24 bg-gray-900 text-gray-300 py-2 px-2'>
            <div className='max-width-[1400px] mx-auto grid grid-cols-2 md:grid-cols-6 border-b-2 border-gray-600 py-8 px-4 my-auto'>
                <div>
                    <h6 className='font-bold uppercase pt-2 pb-2'>Solutions</h6>
                    <ul>
                ...
                <div>
                    <h6 className='font-bold uppercase pt-2 pb-1'>Support</h6>
                    <ul>
                ...
                <div>
                    <h6 className='font-bold uppercase pt-2 pb-1'>Company</h6>
                    <ul>
                ...
                <div>
                    <h6 className='font-bold uppercase pt-2 pb-1'>Legal</h6>
                    <ul>
                ...
                <div className='col-span-2 flex flex-col justify-center py-8 md:pt-2'>
            ...
            {/* Footer */}
            <div className='flex flex-col sm:flex-row max-w-[1400px] mx-auto text-center justify-between px-2 py-4'>
                ...
                <div className='flex flex-row justify-between sm:w-[300px] pt-4 text-2xl'>
                    ...
                    <FaInstagram />
                    <FaTwitter />
                    <TiSocialPinterest size={30} className='-mt-1' />
                </div>
            </div>
        </div>
    )
